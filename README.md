...
Attacker (Kali):
- Open [http://<ubuntu-ip>:3000](http://192.168.56.104:3000)
...
### Deployment Proof
![Docker Running]([https://github.com/Ninitha-67/Securing-Vulnerable-Web-Application-OWASP-Juice-Shop/blob/main/Screenshots/docker_ps_a.png](https://github.com/Ninitha-67/Securing-Vulnerable-Web-Application-OWASP-Juice-Shop/blob/main/Screenshots/docker_container_running.png))
### Application Access
